...
(function($){
	...
	$.updatePosition = function(e) {
		...
		$(currentElement).parent().css("top",  (lastElemTop + spanY));
		$(currentElement).parent().css("left", (lastElemLeft + spanX));
	};
	...
	$.fn.easydrag = function(allowBubbling){
		...
		return this.each(function(){
			...
			$(this).mousedown(function(e){
				...
				lastElemTop  = $(this).parent().get(0).offsetTop;
				lastElemLeft = $(this).parent().get(0).offsetLeft;
